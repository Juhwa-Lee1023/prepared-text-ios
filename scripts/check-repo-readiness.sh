...
grep -q '^## Summary$' .github/pull_request_template.md || record_failure ".github/pull_request_template.md must include a Summary section."
grep -q '^## Changes$' .github/pull_request_template.md || record_failure ".github/pull_request_template.md must include a Changes section."
grep -q '^## Testing$' .github/pull_request_template.md || record_failure ".github/pull_request_template.md must include a Testing section."
grep -q '^## Risks and follow-ups$' .github/pull_request_template.md || record_failure ".github/pull_request_template.md must include a Risks and follow-ups section."
grep -q '^## Related issues$' .github/pull_request_template.md || record_failure ".github/pull_request_template.md must include a Related issues section."
grep -q 'whylog is for commit messages and commit validation here, not for PR bodies' CONTRIBUTING.md || record_failure "CONTRIBUTING.md must explain that whylog is commit-only and PRs use the OSS template."
