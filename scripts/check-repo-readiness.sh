...
grep -q 'npx --yes --package whylog whylog doctor' README.md || record_failure "README.md must document the scaffold-only whylog commands."
grep -q 'npx --yes --package whylog whylog doctor' README.ko.md || record_failure "README.ko.md must document the scaffold-only whylog commands."
grep -q 'npx --yes --package whylog whylog doctor' CONTRIBUTING.md || record_failure "CONTRIBUTING.md must document the scaffold-only whylog commands."
...
grep -q 'npx --yes --package whylog whylog validate' .github/actions/validate-whylog/action.yml || record_failure ".github/actions/validate-whylog/action.yml must use the package-only npx fallback."
